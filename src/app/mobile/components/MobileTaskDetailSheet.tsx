...
import { AsanaStory, CalendarEvent, DelegationQueueEntry } from '@/types';
...
// Read-plus-quick-actions subset of the desktop TaskDetailDialog: details,
// comments and delegation status to read; complete/reopen, comment, delegate
// and move-to-backlog to act. No edit mode, no delete, no metadata editor.
